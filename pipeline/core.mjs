...
/** เพศของเสียง — ใช้ทั้งเลือกประโยคให้อ่านตอนอัด และบอกคนเขียนสคริปต์ว่าลงท้ายยังไง */
export const VOICE_GENDERS = ["หญิง", "ชาย"];
 ...
 *
 * ประโยคสำหรับอ่านตอนอัดมีแยกตามเพศ เพราะภาษาไทยลงท้ายต่างกัน (ครับ/ค่ะ)
 * ให้ผู้ชายอ่าน “สวัสดีค่ะ” แล้วเสียงต้นแบบจะฝืนและไม่เป็นธรรมชาติ
 * ความยาวคุมไว้ราว 4-6 วินาทีเมื่ออ่านปกติ ซึ่งอยู่ในช่วงที่ F5-TTS ทำงานได้ดีที่สุด
 */
export const VOICE_TONES = [
  {
    id: "เป็นกันเอง",
    samples: {
      "หญิง": "สวัสดีค่ะ วันนี้มีของดีมาแนะนำ ลองฟังกันสักนิดนะคะ รับรองว่าไม่ผิดหวังแน่นอน",
      "ชาย": "สวัสดีครับ วันนี้มีของดีมาแนะนำ ลองฟังกันสักนิดนะครับ รับรองว่าไม่ผิดหวังแน่นอน",
    },
  },
  {
    id: "มั่นใจ",
    samples: {
      "หญิง": "ตัวนี้ใช้เองมาสามเดือนแล้วค่ะ บอกได้เลยว่าดีจริง ไม่ได้พูดเกินเลยสักคำ",
      "ชาย": "ตัวนี้ผมใช้เองมาสามเดือนแล้วครับ บอกได้เลยว่าดีจริง ไม่ได้พูดเกินเลยสักคำ",
    },
  },
  {
    id: "ตื่นเต้น",
    samples: {
      "หญิง": "โอ้โห อันนี้ต้องรีบบอกต่อเลยนะคะ ของมันดีจริง ๆ รีบดูก่อนของจะหมดนะ",
      "ชาย": "โอ้โห อันนี้ต้องรีบบอกต่อเลยนะครับ ของมันดีจริง ๆ รีบดูก่อนของจะหมดนะ",
    },
  },
  {
    id: "นุ่มนวล",
    samples: {
      "หญิง": "ค่อย ๆ ฟังนะคะ ไม่ต้องรีบ อยากให้ลองพิจารณาดูดี ๆ ก่อนตัดสินใจค่ะ",
      "ชาย": "ค่อย ๆ ฟังนะครับ ไม่ต้องรีบ อยากให้ลองพิจารณาดูดี ๆ ก่อนตัดสินใจครับ",
    },
  },
  {
    id: "สุขุม",
    samples: {
      "หญิง": "เรื่องนี้ต้องดูกันยาว ๆ ค่ะ จะอธิบายให้ฟังทีละข้อ ค่อย ๆ ทำความเข้าใจไปด้วยกัน",
      "ชาย": "เรื่องนี้ต้องดูกันยาว ๆ ครับ ผมจะอธิบายให้ฟังทีละข้อ ค่อย ๆ ทำความเข้าใจไปด้วยกัน",
    },
  },
  {
    id: "น่าเชื่อถือ",
    samples: {
      "หญิง": "ข้อมูลทั้งหมดนี้มีที่มาชัดเจนค่ะ ตรวจสอบได้ทุกข้อ ไม่มีอะไรปิดบัง",
      "ชาย": "ข้อมูลทั้งหมดนี้มีที่มาชัดเจนครับ ตรวจสอบได้ทุกข้อ ไม่มีอะไรปิดบัง",
    },
  },
];

/** ประโยคให้อ่านของโทนและเพศที่เลือก — ไม่เดาเพศเมื่อยังไม่ได้เลือก */
export function toneSample(toneId, gender) {
  const tone = VOICE_TONES.find((item) => item.id === toneId) ?? VOICE_TONES[0];
  return tone.samples[gender] ?? "";
}
